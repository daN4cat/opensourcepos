...
--
-- Table structure for table `ospos_categories`
--

CREATE TABLE `ospos_categories` (
...
--
-- Dumping data for table `ospos_categories`
--
...
ALTER TABLE `ospos_items`
  ...
  ADD CONSTRAINT `ospos_items_ibfk_3` FOREIGN KEY (`category_id`) REFERENCES `ospos_categories` (`id`);
...
ALTER TABLE `ospos_categories`
  ADD CONSTRAINT `ospos_categories_ibfk_1` FOREIGN KEY (`item_size_category_id`) REFERENCES `ospos_items_sizes_categories` (`id`),
  ADD CONSTRAINT `ospos_categories_ibfk_2` FOREIGN KEY (`supplier_id`) REFERENCES `ospos_suppliers` (`person_id`);
