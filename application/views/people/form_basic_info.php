...
$(document).ready(function()
{
	...
	$("#postcode").autocomplete(url,{
		...
		parse: create_parser('postcode', ["postcode", "village|town|hamlet|city_district|city|county", "state", "country"])
	});
	...
	$("#city").autocomplete(url,{
		...
		parse: create_parser('city', ["postcode", "village|town|hamlet|city_district|city|county", "state", "country"])
	});
